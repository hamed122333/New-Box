...
export const PRODUCTS = {
  CI: { code: 'CI', name: 'Caisse imprimée', short: 'Caisse imprimée', family: 'caisse', printed: true, walls: 1, lead: [7, 10] },
  CV: { code: 'CV', name: 'Caisse vierge', short: 'Caisse vierge', family: 'caisse', printed: false, walls: 1, lead: [7, 10] },
  CID: { code: 'CID', name: 'Caisse imprimée double cannelure', short: 'Imprimée double', family: 'caisse', printed: true, walls: 2, lead: [7, 10] },
  CVD: { code: 'CVD', name: 'Caisse vierge double cannelure', short: 'Vierge double', family: 'caisse', printed: false, walls: 2, lead: [7, 10] },
